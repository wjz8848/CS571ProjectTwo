...
/*
 * ImprovedSimpleLabelNERData2TokenSequence 
...
public class ImprovedSimpleLabelNERdata2TokenSequence extends Pipe
{
	...
	public ImprovedSimpleLabelNERdata2TokenSequence ()
	{
		super (null, new LabelAlphabet());
	}

	public ImprovedSimpleLabelNERdata2TokenSequence (boolean extraFeatures)
	{
		super (null, new LabelAlphabet());
		if (!extraFeatures) {
